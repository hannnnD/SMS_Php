...
if (isset($_GET['delid'])) {
    ...
    try {
        ...
        if ($query->execute()) {
            ...
            echo "<script>window.location.href = 'show-student-inn.php'</script>";     
        } else {
...
<html lang="en">
  <head>
    ...
    <title>QL HSSV - Sinh viên ở trọ</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-center mb-4">
                                        <h4 class="card-title mb-sm-0">Tình hình sinh viên ở trọ</h4>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="font-weight-bold">Địa chỉ ở trọ</th>
                                                    <th class="font-weight-bold">Ngày vào ở</th>
                                                    <th class="font-weight-bold">Ngày ra </th>
                                            ...
                                            <tbody>
                                                ...
                                                $sql ="SELECT StudentID, ChooseCurrentAddress, StudentName, CurrentAddress, StartDate, EndDate
                                                FROM tblresidence
                                                WHERE ChooseCurrentAddress = 'inn';
                                            ...
                                            ";
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($row->ChooseCurrentAddress); ?></td>
